import 'dart:async';
import 'dart:convert';
import 'package:testpro/formss.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:testpro/details.dart';
import 'package:testpro/update_users.dart';
...
class HomePageState extends State<HomePage> {
  ...
  Future<String> getData() async {
    var response = await http.get(
        Uri.encodeFull("http://192.168.42.162:3000/api/client/"),
